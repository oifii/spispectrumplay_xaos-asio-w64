...
*/
int SPECWIDTH=1000;	// display width
int SPECHEIGHT=500;	// display height 
...
BOOL PlayFile(const char* filename)
{
	...
	if(!(chan=BASS_StreamCreate(44100, 2, BASS_STREAM_DECODE|BASS_SAMPLE_FLOAT, MyStreamProc, NULL)))
	{
